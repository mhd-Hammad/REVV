...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cars = [
        { video: "assets/ferrari landing.mp4",          brand: "FERRARI",     name: "SF90",     tagline: "A plug-in hybrid supercar that blends Formula 1-derived engineering with Ferrari's road performance DNA. It delivers explosive acceleration, advanced aerodynamics, and a balance between electric efficiency and pure combustion power." },
        { video: "assets/lambo landing.mp4",            brand: "LAMBORGHINI", name: "REVUELTO", tagline: "The successor to Lamborghini's V12 legacy, combining a naturally aspirated engine with hybrid technology. It features sharp futuristic styling, aggressive aerodynamics, and raw emotional power for extreme driving excitement." },
        { video: "assets/porsche landing update.mp4",   brand: "PORSCHE",     name: "GT3 RS",   tagline: "A track-focused machine engineered for precision and aerodynamic efficiency. Every element is designed for cornering speed, lightweight performance, and race-level responsiveness shaped by motorsport heritage." },
        { video: "assets/bugatti landing.mp4",          brand: "BUGATTI",     name: "CHIRON",   tagline: "A high-performance evolution of the Chiron built for ultimate speed stability. Its quad-turbo W16 engine delivers relentless power for sustained top speeds while maintaining luxury-level comfort and control." },
        { video: "assets/pagani landing.mp4",           brand: "PAGANI",      name: "HUAYRA R", tagline: "A track-only masterpiece focused on mechanical purity and artistic engineering. Powered by a naturally aspirated V12, it delivers raw sound, extreme precision, and handcrafted detail in every component." },
        { video: "assets/mclaren landing  .mp4",        brand: "MCLAREN",     name: "P1",       tagline: "One of the original hybrid hypercars that set a new performance benchmark. It combines electric boost with a twin-turbo V8, delivering seamless power and exceptional aerodynamic balance with emotional driving character." },
        { video: "assets/rimac landing.mp4",            brand: "RIMAC",       name: "NEVERA",   tagline: "A fully electric hypercar redefining acceleration and performance limits. With instant torque across all four motors, it delivers record-breaking speed, precision handling, and a glimpse into zero-emission extreme performance." }
    ];
    ...
    const brandThemes = {
        ferrari:     { bg: '#0D0D0D', accent: '#FF2800', logo: 'assets/Ferrari-Logo.wine.svg' },
        porsche:     { bg: '#0A0A0A', accent: '#CBA135', logo: 'assets/Porsche-Logo.wine.svg' },
        lamborghini: { bg: '#0B0B0B', accent: '#D4AF37', logo: 'assets/Lamborghini-Logo.wine.svg' },
        bugatti:     { bg: '#05070D', accent: '#1E90FF', logo: 'assets/Bugatti-Logo.wine.svg' },
        rimac:       { bg: '#050505', accent: '#00D1FF', logo: 'assets/rimac-automobili-logo.svg' },
        pagani:      { bg: '#111111', accent: '#C0C0C0', logo: 'assets/Pagani_(company)-Logo.wine.svg' },
        mclaren:     { bg: '#0A0A0A', accent: '#FF6A00', logo: 'assets/mclaren logo update.svg' }
    };
