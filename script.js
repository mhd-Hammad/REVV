...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Using Cloudinary transformations: q_auto (auto quality), w_1280 (resize to 1280w)
    const cars = [
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283488/revv/ferrari-landing.mp4",          brand: "FERRARI",     name: "SF90",     tagline: "A plug-in hybrid supercar that blends Formula 1-derived engineering with Ferrari's road performance DNA. It delivers explosive acceleration, advanced aerodynamics, and a balance between electric efficiency and pure combustion power." },
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283616/revv/lambo-landing.mp4",            brand: "LAMBORGHINI", name: "REVUELTO", tagline: "The successor to Lamborghini's V12 legacy, combining a naturally aspirated engine with hybrid technology. It features sharp futuristic styling, aggressive aerodynamics, and raw emotional power for extreme driving excitement." },
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283796/revv/porsche-landing-update.mp4",   brand: "PORSCHE",     name: "GT3 RS",   tagline: "A track-focused machine engineered for precision and aerodynamic efficiency. Every element is designed for cornering speed, lightweight performance, and race-level responsiveness shaped by motorsport heritage." },
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283303/revv/bugatti-landing.mp4",          brand: "BUGATTI",     name: "CHIRON",   tagline: "A high-performance evolution of the Chiron built for ultimate speed stability. Its quad-turbo W16 engine delivers relentless power for sustained top speeds while maintaining luxury-level comfort and control." },
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283738/revv/pagani-landing.mp4",           brand: "PAGANI",      name: "HUAYRA R", tagline: "A track-only masterpiece focused on mechanical purity and artistic engineering. Powered by a naturally aspirated V12, it delivers raw sound, extreme precision, and handcrafted detail in every component." },
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283676/revv/mclaren-landing.mp4",        brand: "MCLAREN",     name: "P1",       tagline: "One of the original hybrid hypercars that set a new performance benchmark. It combines electric boost with a twin-turbo V8, delivering seamless power and exceptional aerodynamic balance with emotional driving character." },
        { video: "https://res.cloudinary.com/dvbapqdru/video/upload/q_auto,w_1280/v1782283856/revv/rimac-landing.mp4",            brand: "RIMAC",       name: "NEVERA",   tagline: "A fully electric hypercar redefining acceleration and performance limits. With instant torque across all four motors, it delivers record-breaking speed, precision handling, and a glimpse into zero-emission extreme performance." }
    ];
